...
echo ""
echo -e "  ${BLUE}source /home/user/pidog_ros2/install/setup.bash${NC}"
echo ""
echo "Then you can run:"
echo -e "  ${GREEN}ros2 launch pidog_gaits collect_data.launch.py${NC}"
echo -e "  ${GREEN}./collect_training_data.sh 40${NC}"
echo ""
